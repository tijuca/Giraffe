...
CONFIG = {
    'data_path': Config.string(default='/var/lib/zarafa/presence/'),
    ...
    'server_auth_password': Config.string(),
    'server_secret_key': Config.string(),
    'server_token_expire': Config.integer(),
    'xmpp_jid': Config.string(),
    'xmpp_password': Config.string(),
    'xmpp_user_id_strip_domain': Config.boolean(),
    'spreed_auto_unavailable': Config.integer(),
}
