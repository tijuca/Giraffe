...
class ZaraPy(object):
    ...
    def viewuser(self, company=None,user=None):
        ...
        for props in zarafa.Server().company(company['company']).user(user['user']).props():
    ...
    def listfolders(self, company=None,user=None,folder=None):
        ...
        if foldername['folder']:
            ...
            for folder in zarafa.Server().company(company['company']).user(user['user']).store.folders():
